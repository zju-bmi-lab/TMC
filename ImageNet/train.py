...
def get_args_parser():
    ...
    parser.add_argument('--epochs', default=213, type=int)
    parser.add_argument('--accum_iter', default=10, type=int,
                        help='Accumulate gradient iterations (for increasing the effective batch size under memory constraints)')
    parser.add_argument('--finetune', default='',
                        help='finetune from checkpoint')
    parser.add_argument('--data_path', default='../../py_project/ViT/dataset/imagenet', type=str,
                        help='dataset path')
    ...
    parser.add_argument('--resume', default='./checkpoint-203.pth',
